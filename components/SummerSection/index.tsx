...
const SummerSection: React.FC<SummerSectionType> = ({ title, img }) => {
	return (
		<div className="bg-[#FBFBFB] flex items-center justify-between summer-section-card pb-[20px] px-[30px]">
			<Image style={{ width: "auto", height: "auto" }} src={img} alt="plant img" width={280} height={280} />
			<div className="w-[300px] pt-[40px] pb-[20px] text-right">

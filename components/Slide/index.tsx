...
const Slide = ({item}) => {
	return (
		<div className={`flex items-center justify-between`}>
			<div className="pt-[68px] pl-[43px] pb-[85px] w-[602px]">
			...
			<Image className="object-contain" style={{ width: "auto", height: "auto" }} src={item.img} alt="hero img" priority width={518} height={450} />
		</div>
	)
}
